...
const socials = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/primar.si',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold font-inter mb-4 tracking-tight">PRIMAR</h3>
            <p className="font-inter text-gray-400 mb-2">
              Primar Servicios Inmobiliarios SA
            </p>
          ...
          >
            <h4 className="text-xl font-bold font-inter mb-4 tracking-tight">Contacto</h4>
          ...
          >
            <h4 className="text-xl font-bold font-inter mb-4 tracking-tight">Síguenos</h4>
            <div className="flex space-x-4">
              {socials.map((s) => (
                <motion.a
                  ...
                  aria-label={s.label}
                  whileHover={{ scale: 1.15, y: -3, backgroundColor: '#ffffff', color: '#000000' }}
                  whileTap={{ scale: 0.92 }}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="border-t border-gray-800 pt-8 text-center font-inter text-gray-400"
        >
          <p>
            &copy; 2026 Primar Servicios Inmobiliarios SA
            <br />
